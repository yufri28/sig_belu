...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Mar 2025 pada 03.26
...
--
-- Dumping data untuk tabel `tanda_larangan`
--

INSERT INTO `tanda_larangan` (`id_larangan`, `f_id_wisata`, `nama_larangan`, `foto`, `latitude`, `longitude`, `keterangan`) VALUES
(2, 5, 'Kolam Buaya', '1741832597511.png', '-9.566116506971282', '124.30736676601288', '-'),
(3, 8, 'Kolam Buaya ss', '1741832657250.jpg', '-9.566116506971282', '124.41281113776452', '-');
...
--
ALTER TABLE `tanda_larangan`
  MODIFY `id_larangan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
